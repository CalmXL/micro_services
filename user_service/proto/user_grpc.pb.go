...
const (
	...
	User_GetUserByMobileNumber_FullMethodName = "/User/GetUserByMobileNumber"
...
type UserClient interface {
	...
	GetUserByMobileNumber(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*UserInfo, error)
...
func (c *userClient) GetUserById(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (c *userClient) GetUserByMobileNumber(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
	err := c.cc.Invoke(ctx, User_GetUserByMobileNumber_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetUserByMobileNumber(context.Context, *UserInfo) (*UserInfo, error)
...
func (UnimplementedUserServer) GetUserById(context.Context, *UserInfo) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserById not implemented")
}
func (UnimplementedUserServer) GetUserByMobileNumber(context.Context, *UserInfo) (*UserInfo, error) {
...
func _User_GetUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserById(ctx, req.(*UserInfo))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_GetUserByMobileNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetUserByMobileNumber(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetUserByMobileNumber_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserByMobileNumber(ctx, req.(*UserInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _User_GetUserByMobileNumber_Handler,
		},
		{
